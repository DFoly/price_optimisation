...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``price_optimisation/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in price_optimisation/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in price_optimisation/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-price_optimisation-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.price_optimisation.price_optimisation-model", "Full (Three-Level) Model Name")
