...
# ``price_optimisation/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-price_optimisation-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.price_optimisation.price_optimisation-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.price_optimisation.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.price_optimisation.trip_dropoff_features",
